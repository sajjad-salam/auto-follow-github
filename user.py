...
friend_username=input('  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}  \x1b[38;5;180m [+] ENTER USERNAME TO EXTRACT USERNAMES FROM IT  : )  \x1b[1;38;5;121m ๛   \x1b[38;5;117m')
# Set the authorization header
headers = {'Authorization': f'token {access_token}'}

# Function to get the list of users following a specific user
def get_followers(username):
    response = requests.get(f"https://api.github.com/users/{username}/followers", headers=headers)
...
if followers:
    with open('users.txt', 'w') as file:
        for user in followers:
            file.write(user + '\n')
    print(f"The list of users following {friend_username} has been saved to followers.txt.")
else:
